    ...
    <td width="625" valign="top"><center><top></top>
      ...
      <div align="left">
        <table width="100%" height="40" border="0">
          <tr>
            <td background="images/back_titulos.jpg"><div align="center" class="style21">Nossos Acess&oacute;rios </div></td>
          </tr>
        </table>
      </div>
      <div align="left"><br>
      ...
      <table width="100%" border="0">
        <tr>
          <td><img src="images/acessorios.jpg" width="639" height="536"></td>
        </tr>
      </table>
      <br>      
      <br></td>
