...
<table width="1000">
  <tr>
    ...
    <div align="center" class="style7"><span class="style10">Cosplays em Destaques </span></div></td>
...
?></a></td>
    ...
    <td valign="top"><div align="left">
      <table width="100%" border="0">
        <tr>
          <td width="34%"><img src="images/cosplay01.jpg" width="128" height="127"></td>
          <td width="66%"><img src="images/cosplay02.jpg" width="128" height="146"></td>
          <td width="66%"><img src="images/cosplay03.jpg" width="128" height="174"></td>
        </tr>
        <tr>
          <td valign="top"><h4 class="style18"><strong>vocaloid Hatsune Miku peruca cosplay</strong></h4>
          <div class="style16">R$20,00</div>
            <h2 align="left" class="style18">&nbsp;</h2>
            <div>
            <br></td>
          <td valign="top" class="style16"><h2 class="style18">naruto manto akatsuki cosplay <br>
            <br>
          </h2>
            <div class="style18"><span id="product-price-1051">R$22,50</span></div></td>
          <td valign="top"><div align="left">
            <h4 class="style18"><strong>bleach Ichigo Kurosaki bankai traje cosplay forma</strong></h4>
    ...
    <td width="625" valign="top"><center><top></top>
      ...
      <div align="left">
        <table width="100%" height="40" border="0">
          <tr>
            <td background="images/back_titulos.jpg"><div align="center" class="style21">Nossos Cosplays </div></td>
          </tr>
        </table>
      </div>
      <div align="left"><br>
      ...
      <table width="100%" border="0">
        <tr>
          <td><img src="images/cosplays04.jpg" width="639" height="510"></td>
        </tr>
      </table>
      <br>      
      <br></td>
